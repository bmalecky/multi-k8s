...
kubectl set image deployments/server-deployment server=bmaleckysandbox/multi-client:$SHA
kubectl set image deployments/worker-deployment server=bmaleckysandbox/multi-worker:$SHA
